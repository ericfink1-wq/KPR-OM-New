...
REQUIRED SCHEMA:
{
  ...
  "currentAssessedValue": "number or null — the property's CURRENT total ASSESSED (or taxable) value from the OM's real-estate-tax overview / parcel table (sum across parcels). This is the assessor's value, NOT the asking price. In Michigan use the TAXABLE value; elsewhere the total assessed value.",
  "currentAnnualTaxes": "number or null — the property's CURRENT total annual real-estate TAXES actually billed, from the OM's tax overview / parcel table (sum across parcels, most recent year). NOT a pro-forma/underwritten tax figure.",
