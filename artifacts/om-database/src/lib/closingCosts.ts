  ...
  DC: {
    ...
    transferTaxes: [
      { name: "Deed Transfer Tax (Seller)", rate: 0.0145, base: "price", party: "seller",
        notes: "DC commercial deed transfer tax: 1.45% (consideration >$400K; <$400K is 1.1%). Customarily SELLER. This is ONE of the two DC deed taxes." },
      { name: "Deed Recordation Tax (Buyer)", rate: 0.0145, base: "price", party: "buyer",
        notes: "DC commercial deed recordation tax: 1.45% (>$400K). Customarily BUYER. Transfer (1.45%) + recordation (1.45%) = the 2.9% COMBINED deed tax DC commercial transfers carry (per DC OTR, eff. for commercial without thresholds). NOT 1.45% on each side of EACH tax." },
    ],
    mortgageRecordingTax: { name: "Mortgage Recordation Tax (Deed of Trust)", rate: 0.0145, base: "loan", party: "buyer",
      notes: "DC also charges the 1.45% recordation tax on the deed of trust / security instrument. Buyer pays. On a 65% LTV deal adds ~0.94% of price." },
    recordingFeesFlat: 150,
    notes: "DC commercial deeds carry a COMBINED 2.9% deed tax (1.45% transfer, customarily seller + 1.45% recordation, customarily buyer) — NOT 4%+. Plus 1.45% recordation on the deed of trust (buyer). One of the most expensive jurisdictions. Verify with DC OTR (otr.cfo.dc.gov); parties often negotiate the split.",
  },
