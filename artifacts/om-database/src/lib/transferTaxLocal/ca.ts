...
export const CA_LOCAL: LocalTaxTable = {
  ...
  { id: "ca-los-angeles-county-culver-city-city", kind: "municipal", name: "Culver City city", county: "Los Angeles County", lines: [
  ...
  { id: "ca-alameda-county-berkeley-city", kind: "municipal", name: "Berkeley city", county: "Alameda County", lines: [
  ...
  { id: "ca-santa-clara-county-san-jose-city", kind: "municipal", name: "San Jose city", county: "Santa Clara County", lines: [
  ...
  { id: "ca-santa-clara-county-palo-alto-city", kind: "municipal", name: "Palo Alto city", county: "Santa Clara County", lines: [
  ...
  { id: "ca-santa-clara-county-mountain-view-city", kind: "municipal", name: "Mountain View city", county: "Santa Clara County", lines: [
  ...
  { id: "ca-sacramento-county-sacramento-city", kind: "municipal", name: "Sacramento city", county: "Sacramento County", lines: [
  ...
  { id: "ca-solano-county-vallejo-city", kind: "municipal", name: "Vallejo city", county: "Solano County", lines: [
  ...
  { id: "ca-marin-county-san-rafael-city", kind: "municipal", name: "San Rafael city", county: "Marin County", lines: [
