...
export const WA_LOCAL: LocalTaxTable = {
  ...
  { id: "wa-san-juan-county-unincorporated-2800", kind: "municipal", verify: "San Juan's 2.0% local rate includes a 1.0% land-bank tax (buyer) and a 0.5% housing tax whose 99%-buyer / 1%-seller split comes from search text of the county code (not readable directly). Confirm the split.", name: "Unincorporated San Juan County", county: "San Juan County", match: ["unincorporated"], lines: [
  ...
  { id: "wa-san-juan-county-friday-harbor-town-2801", kind: "municipal", verify: "San Juan's 2.0% local rate includes a 1.0% land-bank tax (buyer) and a 0.5% housing tax whose 99%-buyer / 1%-seller split comes from search text of the county code (not readable directly). Confirm the split.", name: "Friday Harbor town", county: "San Juan County", lines: [
