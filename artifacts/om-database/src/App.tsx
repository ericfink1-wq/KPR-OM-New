...
function AppInner() {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      style={{ minHeight: "100vh", background: "#f6f2ea", display: "flex", flexDirection: "column", fontFamily: "'Inter',-apple-system,sans-serif", color: "#383a37", WebkitFontSmoothing: "antialiased" as any }}>
