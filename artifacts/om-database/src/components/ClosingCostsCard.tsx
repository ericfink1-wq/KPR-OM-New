...
import {
  getJurisdiction, calculateClosingCosts, formatRate,
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5 }}>
          ...
          <tbody>
            {breakdown.lines.map((l, i) => {
              const dormant = (l as any).entitySaleOnly && !entitySale;
              return (
                <tr key={i} style={{ borderBottom: "1px solid #f5efe2", opacity: dormant ? 0.5 : 1 }}>
